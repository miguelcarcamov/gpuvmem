...
function(gpuvmem_gtest_common_target_props TARGET)
  ...
  target_link_libraries(${TARGET} PRIVATE GTest::gtest_main gpuvmem_external_deps m)
...
# Kept for call sites; deps are already applied via gpuvmem_gtest_common_target_props.
function(gpuvmem_link_test_external_libs TARGET)
  target_link_libraries(${TARGET} PRIVATE gpuvmem_external_deps)
endfunction()
