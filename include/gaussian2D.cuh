...
__host__ Gaussian2D(int m, int n, float dx, float dy, Io *imageHandler, CKernel *gcf);
...
__host__ Gaussian2D(int m, int n, float dx, float dy, float w, Io *imageHandler);
__host__ Gaussian2D(int m, int n, float dx, float dy, float w, Io *imageHandler, CKernel *gcf);
...
__host__ void buildGCF(float amp, float x0, float y0, float sigma_x, float sigma_y);
