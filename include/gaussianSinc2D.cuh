...
__host__ GaussianSinc2D(int m, int n, float w, float w2, Io *imageHandler, CKernel *gcf);
__host__ GaussianSinc2D(int m, int n, float dx, float dy, float w, float w2);
__host__ GaussianSinc2D(int m, int n, float dx, float dy, float w, float w2, CKernel *gcf);
__host__ GaussianSinc2D(int m, int n, float dx, float dy, float w, float w2, Io *imageHandler);
__host__ GaussianSinc2D(int m, int n, float dx, float dy, float w, float w2, Io *imageHandler, CKernel *gcf);
