...
__host__ PillBox2D(int m, int n, float dx, float dy, Io *imageHandler, CKernel *gcf);
...
__host__ PillBox2D(int m, int n, float dx, float dy, float w, Io *imageHandler);
__host__ PillBox2D(int m, int n, float dx, float dy, float w, Io *imageHandler, CKernel *gcf);
