...
__host__ Sinc2D(int m, int n, float dx, float dy, Io *imageHandler, CKernel *gcf);
...
__host__ Sinc2D(int m, int n, float dx, float dy, float w, Io *imageHandler, CKernel *gcf);
