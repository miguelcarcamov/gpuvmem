...
__host__ PSWF_12D(int m, int n, float dx, float dy, Io *imageHandler, CKernel *gcf);
...
__host__ PSWF_12D(int m, int n, float dx, float dy, float w, Io *imageHandler, CKernel *gcf);
