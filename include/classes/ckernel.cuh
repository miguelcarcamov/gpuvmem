...
class CKernel {
 public:
  ...
  __host__ float getAmp() { return this->amp; };
  __host__ int getm() { return this->m; };
  __host__ int getn() { return this->n; };
  ...
  __host__ int getSigmaX() { return this->sigma_x; };
  __host__ int getSigmaY() { return this->sigma_y; };
  __host__ int getSupportX() { return this->support_x; };
  __host__ int getSupportY() { return this->support_y; };

  __host__ int getGPUID() { return this->gpu_id; };

  __host__ float getW() { return this->w; };

  __host__ float getX0() { return this->x0; };

  __host__ float getY0() { return this->y0; };
  ...
  __host__ void setAmp(float amp) { this->amp = amp; };
  ...
  __host__ void setGPUID(int gpu_id) { this->gpu_id = gpu_id; };

  __host__ void printGCF() {
    if (this->gcf->getImageHandler() != NULL &&
 ...
 private:
  ...
  __host__ void setm_times_n() { this->m_times_n = this->m * this->n; };
  ...
  __host__ void freeGPUKernel() { cudaFree(this->gpu_kernel); };
 ...
 protected:
  ...
  __host__ void setKernelMemory() {
    ...
    checkCudaErrors(
        cudaMalloc(&this->gpu_kernel, sizeof(float) * this->m_times_n));
    checkCudaErrors(
        cudaMemset(this->gpu_kernel, 0, sizeof(float) * this->m_times_n));
  };
