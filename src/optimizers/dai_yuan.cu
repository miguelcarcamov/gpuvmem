...
float DaiYuan::computeConjugateGradientParameter(
...
namespace {
Optimizer* CreateDaiYuan() {
  return new DaiYuan;
}

const std::string name_dy = "CG-DaiYuan";
const bool RegisteredDY =
    registerCreationFunction<Optimizer, std::string>(name_dy, CreateDaiYuan);
}  // namespace
