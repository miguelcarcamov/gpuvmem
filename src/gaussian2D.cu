...
__host__ Gaussian2D::Gaussian2D(int m,
                                int n,
                                float dx,
                                float dy,
                                Io* imageHandler)
...
__host__ void Gaussian2D::buildKernel(float amp,
                                      float x0,
                                      float y0,
                                      float sigma_x,
                                      float sigma_y) {
...
__host__ float Gaussian2D::GCF(float amp,
                               float x,
                               float y,
                               float x0,
                               float y0,
...
__host__ void Gaussian2D::buildGCF(float amp,
                                   float x0,
                                   float y0,
                                   float sigma_x,
                                   float sigma_y) {
