...
IoFITS::IoFITS(std::string input, std::string output, std::string path, int M,
               int N, float normalization_factor, bool print_images)
    : Io(input, output, path) {
  this->M = M;
  this->N = N;
  this->normalization_factor = normalization_factor;
  this->print_images = print_images;
  if (this->print_images && this->path != "") createFolder(this->path);
};

bool IoFITS::getPrintImages() { return this->print_images; };

void IoFITS::setM(int M) { this->M = M; };

void IoFITS::setN(int N) { this->N = N; };
...
void IoFITS::printImage(float *I, char *path, char *name_image, char *units,
...
void IoFITS::printImage(float *I, char *name_image, char *units, int iteration,
...
void IoFITS::printImage(float *I, char *units, int iteration, int index,
...
void IoFITS::printNotPathImage(float *I, char *units, int iteration, int index,
                               float fg_scale, long M, long N, bool isInGPU) {
  OCopyFITS(I, getConstCharFromString(this->input), "",
            getConstCharFromString(this->output), units, iteration, index,
            fg_scale, M, N, isInGPU);
...
void IoFITS::printNotPathImage(float *I, char *out_image, char *units,
                               int iteration, int index, float fg_scale, long M,
                               long N, bool isInGPU) {
...
void IoFITS::printNotNormalizedImage(float *I, char *name_image, char *units,
                                     int iteration, int index, bool isInGPU) {
  OCopyFITS(I, getConstCharFromString(this->input),
            getConstCharFromString(this->path), name_image, units, iteration,
...
void IoFITS::printNotPathNotNormalizedImage(float *I, char *name_image,
...
void IoFITS::printImageIteration(float *I, char const *name_image, char *units,
...
void IoFITS::printNotNormalizedImageIteration(float *I, char const *name_image,
                                              char *units, int iteration,
                                              int index, bool isInGPU) {
  size_t needed;
  char *full_name;
...
void IoFITS::printImageIteration(float *I, char *model_input, char *path,
...
void IoFITS::printcuFFTComplex(cufftComplex *I, fitsfile *canvas,
...
void IoFITS::printcuFFTComplex(cufftComplex *I, char *input, char *path,
...
void IoFITS::closeHeader(fitsfile *header) { closeFITS(header); };

namespace {
Io *CreateIoFITS() { return new IoFITS; }
