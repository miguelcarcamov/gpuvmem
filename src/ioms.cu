...
void IoMS::IowriteMS(char const *outfile, char const *out_col, Field *fields, MSData data, float random_probability, bool sim, bool noise, bool W_projection, int verbose_flag)
{
