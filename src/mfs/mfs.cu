...
// Global variables for line search functions (used by f1dim and evaluateLineFunction)
float* device_pcom = nullptr;
float* device_xicom = nullptr;
float (*nrfunc)(float*) = nullptr;
